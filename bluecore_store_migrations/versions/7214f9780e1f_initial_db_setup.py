...
Revision ID: 7214f9780e1f
Revises: 
Create Date: 2025-01-17 13:42:54.085056
...
def upgrade() -> None:
    ...
    op.create_table('triple_vector_index',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('triple_vector_index')
