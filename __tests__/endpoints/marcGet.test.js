...
describe('GET /:resourceId/job/:username/:timestamp', () => {
  describe('MARC does not exist', () => {
    it('returns 200', async () => {
      ...
      expect(aws.hasMarc).toHaveBeenCalledWith('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z')
    })
  })
  ...
  describe('MARC exists', () => {
    it('returns MARC url', async () => {
      ...
      expect(res.header.location).toEqual('https://api.development.sinopia.io/marc/6852a770-2961-4836-a833-0b21a9b68041/version/jdoe/2020-08-20T11:34:40.887Z')
    })
  })
...
describe('GET /:resourceId/version/:username/:timestamp', () => {
  describe('requesting MARC', () => {
    ...
    it('returns MARC', async () => {
      const res = await request(app)
        .get('/marc/6852a770-2961-4836-a833-0b21a9b68041/version/jdoe/2020-08-20T11:34:40.887Z')
        .set('Accept', 'application/marc')
      expect(res.statusCode).toEqual(200)
      expect(res.type).toEqual('application/marc')
      expect(res.text).toEqual('MARC record')
      expect(aws.getMarc).toHaveBeenCalledWith('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z', false)
    })
  })
  ...
  describe('requesting MARC text', () => {
    it('returns MARC text', async () => {
      ...
      expect(res.text).toEqual('MARC record')
      expect(aws.getMarc).toHaveBeenCalledWith('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z', true)
    })
  })
})
