...
describe('DELETE /resource/:resourceId', () => {
  ...
  it('removes existing resource', async () => {
    ...
    expect(mockResourceDelete).toHaveBeenCalledWith({id: '6852a770-2961-4836-a833-0b21a9b68041'})
    expect(mockResourceVersionsDelete).toHaveBeenCalledWith({id: '6852a770-2961-4836-a833-0b21a9b68041'})
    expect(mockResourceMetadataDelete).toHaveBeenCalledWith({id: '6852a770-2961-4836-a833-0b21a9b68041'})
  })
