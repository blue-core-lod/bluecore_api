  ...
  describe('resource found', () => {
    it('requests MARC and return job URL', async () => {
      ...
      const res = await request(app)
        ...
        .set('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMiwiY29nbml0bzp1c2VybmFtZSI6Impkb2UifQ.Rmfs_TH1hYeCcQrTmoOXxA3f0UC1yhgTRdYLUSmRw-c')
        .send()
