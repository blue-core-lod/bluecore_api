...
describe('hasMarc', () => {
  describe('finds MARC record', () => {
    it('resolves true', async () => {
      mockListObjects.mockImplementation((params, callback) => {
        expect(params).toEqual({
          Bucket: 'sinopia-marc-development',
          Prefix: 'marc/jdoe/6852a770-2961-4836-a833-0b21a9b68041/2020-08-20T11:34:40.887Z'
        })
        callback(null, {Contents: [{Key: 'marc/jdoe/6852a770-2961-4836-a833-0b21a9b68041/2020-08-20T11:34:40.887Z/record.mar'}]})
      })
      expect(await hasMarc('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z')).toBe(true)
    })
  })
  ...
  describe('finds error file', () => {
    it('retrieves error file and rejects', async () => {
      mockListObjects.mockImplementation((params, callback) => {
        callback(null, {Contents: [{Key: 'marc/jdoe/6852a770-2961-4836-a833-0b21a9b68041/2020-08-20T11:34:40.887Z/error.txt'}]})
      })
      mockGetObject.mockImplementation((params, callback) => {
        ...
        callback(null, {Body: {toString: jest.fn().mockReturnValue('Bad record')}})
      })
      await expect(hasMarc('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z')).rejects.toThrow('Bad record')
    })
  })
  ...
  describe('finds no files', () => {
    it('resolves false', async () => {
      ...
      expect(await hasMarc('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z')).toBe(false)
    })
  })
})
...
describe('getMarc', () => {
  describe('getting MARC record', () => {
    it('resolves record', async () => {
      ...
      expect(await getMarc('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z')).toBe('The record')
    })
  })
  ...
  describe('getting MARC text', () => {
    it('resolves text', async () => {
      ...
      expect(await getMarc('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z', true)).toBe('The record')
    })
  })
  ...
  describe('error', () => {
    it('rejects', async () => {
      ...
      await expect(getMarc('6852a770-2961-4836-a833-0b21a9b68041', 'jdoe', '2020-08-20T11:34:40.887Z')).rejects.toThrow('Get failed')
    })
  })
})
