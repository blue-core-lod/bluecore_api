"""Unit tests for serialize/sidebar.py -- how a record links to its neighbours.
...
def test_add_section_folds_into_an_open_section_of_the_same_name():
    ...
    _add_section(sidebar, "Series", [{"text": "b", "href": None}])
...
def test_add_section_drops_a_value_already_in_the_section():
    ...
    _add_section(sidebar, "Series", [{"text": "a", "href": None}])
...
def test_add_section_appends_a_new_heading():
    ...
    _add_section(sidebar, "Has Instance", [{"text": "b", "href": None}])
